...
public static class AIDirectionBehaviour 
{
    public static double GetRadian(GameObject source, GameObject destination, float offset)
    {
         ...
         */
        float destinationx = destination.transform.position.x - source.transform.position.x;
        float destinationy = destination.transform.position.y - source.transform.position.y;
    ...
    {
        /* Same as above but this time the actual position of the object is used
         * instead of the objct itself.
         */
    ...
    public static Vector2 GetDirectionVector(GameObject source, GameObject destination, float offset, float size = 1)
    {
         ...
         * convert angle to an actual position.
    ...
    public static Vector2 FindPositionOf(GameObject source, GameObject destination, float offset)
    {
         ...
         * It is the last part of converting an angle to an actual position because
         * gives the actual x, y position of the wanted direction vector. 
         */
